...
( () => {
    ...
    var e = {
        202: (e, t, r) => {
            ...
            function m(e, t, r) {
                ...
                const l = function(e, t) {
                    var r, n, o, i;
                    const {message: s, additional: l={}} = (0,
                    a.S)(e.message || String(e))
                      , d = {
                    ...
                    return d.additional = c(c(c(c({}, e.additional), t.additional), u), l),
                    d
                }(t, r);
                r.message && (l.message = r.message),
                r.prefix && (l.message = `${r.prefix} ${l.message}`),
        ...
        462: (e, t, r) => {
            ...
            const a = [{
              ...
              , o = e => {
                ...
                return r.additional && (a.additional = r.additional),
                a
            }
        }
        ,
        ...
        327: (e, t, r) => {
            ...
            class n extends Error {
                constructor({code: e, message: t}, r, a) {
                    super(t, r, a),
                    this.name = "AuthError",
                    this.code = e,
            ...
            class _ {
                ...
                _handleEvent(e) {
                    const {type: t, action: r, messageId: n, originMessageId: o, payload: i, originPayload: s, data: d, error: c, errorJSON: u} = e.data || {}
                      , p = this._promises[o];
                    p && (this.deletePromise(o),
                    void 0 === c ? p.resolve({
                        type: t,
                        action: r,
                        originPayload: s,
                ...
                _post(e, t) {
                    ...
                    if ("timeout"in t) {
                        ...
                        "number" == typeof e && e > 0 ? this._promises[n].timeoutId = window.setTimeout(( () => {
                            ...
                            i(new Error("Message rejected by timeout"))
                        }
                        ), e) : (0,
                        a.fF)(new Error("Wrong timeout value"))
                    }
                    return s
                }
            }
            ...
            if ("object" == typeof window)
                ...
                window.YandexGamesSDKGlobals.messaging || (window.YandexGamesSDKGlobals.messaging = new _),
                g = window.YandexGamesSDKGlobals.messaging;
            else {
                const e = () => {
        ...
        591: (e, t, r) => {
            ...
            function d() {
                var e, t, r;
                return "undefined" == typeof window ? "" : (null == (e = window.YandexGamesSDK) ? void 0 : e.environment) ? window.YandexGamesSDK.environment.app.id : window.YandexGamesSDKEnvironment ? window.YandexGamesSDKEnvironment.app.id : ((0,
                o.H)({
                    block: i.W.UTILS_LOCATION,
        ...
        42: (e, t, r) => {
            ...
            function n(e, t) {
                var r, n;
                return t ? "string" == typeof t.entryQuery[e] ? t.entryQuery[e] : void 0 : "object" == typeof window ? (null == (n = null == (r = window.appData) ? void 0 : r.location) ? void 0 : n.entryQuery[e]) || (0,
                a.Z)(window.location)[e] : void 0
            }
        }
        ,
        399: (e, t, r) => {
            ...
            const h = function(e, t) {
                ...
                let g = e
                  ...
                  , P = ( (e, t) => {
                    var r = {};
                    for (var a in e)
                        d.call(e, a) && t.indexOf(a) < 0 && (r[a] = e[a]);
                    if (null != e && l)
                        for (var a of l(e))
                ...
                v = k,
                f = f || (null == (s = null == (r = window.Ya) ? void 0 : r.Rum) ? void 0 : s.ERROR_LEVEL.ERROR) || "error",
                t = t || e,
                S && (y = p({
                    additional: y
                }, S)),
                ...
                const A = p({
                    additional: y,
                    block: null != (u = P.block) ? u : a.W.RUM_UNSPECIFIED,
        ...
        776: (e, t, r) => {
            ...
            const a = ["com"]
              , n = {
                ...
                by: ["be", "ru"],
                "co.il": ["he"],
                com: ["en", "af", "am", "ar", "az", "be", "bg", "bn", "ca", "cs", "da", "de", "el", "en", "es", "et", "eu", "fa", "fi", "fr", "gl", "he", "hi", "hr", "hu", "hy", "id", "is", "it", "ja", "ka", "kk", "km", "kn", "ky", "lo", "lt", "lv", "mk", "ml", "mn", "mr", "ms", "my", "ne", "nl", "no", "pl", "pt", "ro", "ru", "si", "sk", "sl", "sr", "sv", "sw", "ta", "te", "tg", "th", "tk", "tl", "tr", "uk", "ur", "uz", "vi", "zh", "zu"],
                "com.am": ["hy"],
                "com.ge": ["ka"],
                "com.tr": ["tr"],
                ee: ["et"],
            ...
            Object.keys(n).reduce(( (e, t) => (e[t] = n[t][0],
            e)), {});
            ...
            var _ = (e => (e.ADAPTIVE_RECOMMENDED_NEW = "adaptive_recommended_new",
            ...
            new RegExp(`^https://([^.]+\\.){0,7}${y}\\/`),
            `(playhop\\.(${a.map((e => e.replace(".", "\\."))).join("|")}))`)
              , v = (new RegExp(f),
            new RegExp(`^https://([^.]+\\.){0,7}${f}$`))
            ...
            new RegExp(`^https://([^.]+\\.){0,7}${y}/games/igrotok`),
            new RegExp(`^https?://(?:[^.]+\\.){0,7}${y}/games/manifest/app/\\d+/?`),
            new RegExp(`^https?://(?:[^.]+\\.){0,7}${y}/games/manifest/catalogue/.*`),
            new RegExp(`^https?://(?:[^.]+\\.){0,7}${y}/games/manifest/sdk/.*`);
            const b = "from-gametok"
              , E = "is-gametok"
              , P = "igrotok_mode";
            var k = (e => (e.IGROTOK = "igrotok",
            e.IGROYAL = "igroyal",
            e.PLAYHOP = "playhop",
            e.YANDEX = "yandex",
            e))(k || {})
        ...
        159: (e, t, r) => {
            ...
            var a = (e => (e.ADV_STICKY = "AdvSticky",
        ...
        419: e => {
            ...
            e.exports = function(e, r, a, n) {
                ...
                s > 0 && l > s && (l = s);
                for (var d = 0; d < l; ++d) {
                    var c, u, p, m, h = e[d].replace(i, "%20"), _ = h.indexOf(a);
                    _ >= 0 ? (c = h.substr(0, _),
                    u = h.substr(_ + 1)) : (c = h,
                    u = "");
                    try {
        ...
        ,
        751: (e, t, r) => {
            t.decode = t.parse = r(419),
            t.encode = t.stringify = r(509)
        }
    }
      , t = {};
    ...
    ( () => {
        ...
        var t = r(828);
        const n = e => {
            const {async: t, content: r, crossorigin: a, id: n, nonce: o, onErrCb: i, onLoadCb: s, parentElement: l, src: d} = e
            ...
            n && (c.setAttribute("id", `${n}-script`),
            c.dataset.rCid = `load-script-${n}`),
            r) {
        ...
        function m(e="") {
            return e.endsWith(`${p.U_6.YA}.ru`)
        }

        function h(e, t="ru", r) {
            return e = e.replace("%TLD%", t),
            "ru" === t && m(r) && (e = e.replace(`${p.U_6.YANDEX}.ru`, `${p.U_6.YA}.ru`)),
            e
        }
        ...
        function v(e) {
            ...
            return Object.setPrototypeOf(r, this.constructor.prototype),
        ...
        ( () => {
          ...
          , S = class e extends w {
            constructor(t, r, a) {
                ...
                this),
                this.tag = t => new e(this.prefix,this.initialTag.concat(t),this.color),
                this.prefix = t,
                this.color = a,
                this.initialTag = [].concat(r),
            ...
            static GetLogFunc() {
                return 0 === P ? "dummyLog" : f.HasFlag(P, 2) ? "extendedLog" : "simpleLog"
            }
            dummyLog(...e) {}
            simpleLog(...t) {
            ...
            extendedLog(...t) {
                if (console.groupCollapsed(`%c${this.label}%c${this.prefix}%c`, e.labelStyle, this.prefixStyle, e.dataStyle, ...t),
            ...
            clientLog(...t) {
                ...
                this.color && (n.color = this.color),
                this.spoilerData.length && (n.spoilerData = T(this.spoilerData)),
                E.push(n)
            }
            log(...t) {
                "object" == typeof window && this.clientLog(...t),
                this[e.LOG_FUNC](...t)
            }
        }
        ;
        S.labelStyle = "\n        background: dimgrey;\n        color: darkgrey;\n        font-size: 8px;\n        font-weight: normal;\n        border-radius:4px 0 0 4px;\n        padding: 2px\n    ",
        S.dataStyle = "font-weight: normal;",
        S.LOG_SIZE = S.GetLogSize(),
        S.LOG_FUNC = S.GetLogFunc();
        let A = S;
                ...
                return e.map((e => "object" == typeof e ? function(e, t=1) {
                    ...
                    return JSON.stringify(function e(t, a) {
                        if (!t || "object" != typeof t)
                            return t;
                        let n, o = Array.isArray(t), i = r.has(t);
                        return r.set(t, !0),
                        i ? n : (JSON.stringify(t, (function(r, i) {
                            if (o || a > 0) {
                                if (!r)
                                    return o = Array.isArray(i),
                                    t = i,
                                    i;
                                !n && (n = o ? [] : {}),
                                n[r] = e(i, o ? a : a - 1)
        ...
        , D = (e, t, r, a) => (x(e, t, "write to private field"),
        ...
        const R = class {
            ...
            get state() {
                return x(e = this, t = I, "read from private field"),
                r ? r.call(e) : t.get(e);
                var e, t, r
            }
        }
        ...
        class N {
            constructor(e) {
                ...
                this.subscribe = (e, t) => {
                    var r, a;
                    return (null != (a = (r = this.observers)[e]) ? a : r[e] = []).push(t),
        ...
        const G = {
          ...
          , B = class {
            constructor() {
                this.log = O("Achievements | Child frame", b.Dev, G),
                this.observable = new N(this.log),
                this.setProgress = (e, t) => M(this, null, (function*() {
                ...
                this.getProgress = e => M(this, null, (function*() {
                    return this.post("getProgress", {
                        id: e
                    })
                }
                )),
                this.getList = (...e) => M(this, [...e], (function*(e=["allLocal"]) {
                    return this.post("getList", {
                        status: e
                    })
                }
                )),
                this.on = ({action: e, id: t=""}, r) => this.observable.subscribe(this.buildId(e, t), r),
                this.off = ({action: e, id: t}, r) => this.observable.unsubscribe(this.buildId(e, t), r),
                this.post = (e, t) => M(this, null, (function*() {
                    this.log("post to parent", e, t);
                    const r = C(`AchvManager.${e}`);
                    return d.Z.postToParent({
                        ...
                        const {result: a, success: n, error: o} = r.data;
                        return n && a ? (this.notify(e, t, a),
                        a) : (this.log("reject", e, "due to error"),
                        Promise.reject(o))
                    }
                    )).finally(( () => {
                        r()
                ...
                this.notify = (e, t, r) => {
                    ...
                    t.id && a.push(this.buildId(e, t.id)),
                    this.observable.notifyObservers(a, {
                        data: r,
                        payload: t
                    })
                }
        ...
        ;
        B.init = () => {
            const {getList: e, getProgress: t, off: r, on: a, setProgress: n} = new B;
            return {
                getList: e,
                getProgress: t,
                off: r,
        ...
        function W() {
            ...
            function() {
                ...
                "function" == typeof (null == (r = null == (t = null == (e = window.Ya) ? void 0 : e.Context) ? void 0 : t.AdvManager) ? void 0 : r.render) && (window.Ya.Context.AdvManager.render = a.render),
                U();
                let n = window.Ya;
                Object.defineProperty(window, "Ya", {
                    get() {
                        var e;
                        return (null == (e = null == n ? void 0 : n.Context) ? void 0 : e.AdvManager) && n.Context.AdvManager !== a && (n.Context.AdvManager = a),
                        U(),
                        n
                    },
                    set(e) {
                        var t;
                        (null == (t = e.Context) ? void 0 : t.AdvManager) && e.Context.AdvManager !== a && (e.Context.AdvManager = a),
                        n = e
                    },
                    enumerable: !0,
                    configurable: !0
                ...
                window.Ya.Context.AdvManager = a,
                j("disable Ya.Context.AdvManager.render")
            }())
        }
        ...
        const z = "2795"
          ...
          , X = {
            ...
            iceboarding: "iceboarding",
            iceboardingOnlyHome: "iceboarding_only_home",
            iceboardingFeedMode: "dj_experiment_param",
            ...
            prebidCatalogAdv: "prebid_catalog_adv_2",
            ...
            newPlayTimeEndpoint: "new_play_time_endpoint",
            externalGetPlayTime: "external_get_play_time",
        ...
        const oe = new class {
            ...
            get pixelsToInit() {
                ...
                return te(null != (r = null == (t = null == (e = window.appData) ? void 0 : e.abt) ? void 0 : t.flags) ? r : {}, X.cfMirrorStatic, !0) && (a = "https://statics.games-storage-aws.yandex.net/statics/pixels/google-tag-manager.html"),
                this.pixelsOrigin = new URL(a).origin,
                [{
                    frameURL: a,
            ...
            sendEvent(e, t) {
                "string" == typeof e ? Object.entries(this.pixelStorage).forEach(( ([r,a]) => {
                    a.isError || (a.isLoaded ? (a.sendEventFunc(e, t),
                    ne(`Send ${r} goal ${e}`)) : a.eventsQueued.push({
                        goal: e,
                        params: t
                    }))
                }
            ...
            initPixelIframe(e, t, r) {
                ...
                e.onload = () => {
                    this.pixelStorage[r].isLoaded = !0,
                    this.pixelStorage[r].isError = !1,
                    this.sendAllEventFromQueue(r)
                }
                ,
                e.onerror = () => {
                    this.pixelStorage[r].isError = !0,
                    this.pixelStorage[r].isLoaded = !1,
                    this.pixelStorage[r].eventsQueued = []
                }
                ,
        ...
        function ue(e, t, r={}, a) {
            var n;
            "string" == typeof t && (ce(e, t, r),
            ie.sendEvent(t, r),
            a && (null == (n = window.clickdaemonLog) || n.call(window, t, r)))
        }
        ...
        function pe(e, t, r, ...a) {
            ...
            let o = {}
              , i = {};
            if (a[0] && "object" == typeof a[0] ? [o] = a : a[1] && "object" == typeof a[1] && ([,o] = a,
            [,i] = a),
            !o.appVersion) {
            ...
            !o.service && window.clientMetadata.serviceName && (o.service = window.clientMetadata.serviceName),
            !o.platform_id && window.clientMetadata.platform && (o.platform_id = window.clientMetadata.platform),
            window.ym ? (window.ym(e, t, ...a),
            ue(t, a[0], i, n)) : window[`yaCounter${e}`] ? (window[`yaCounter${e}`][t](...a),
            ue(t, a[0], i, n)) : me("Cannot send metrika")
        }
        ...
        function me(e) {
            ...
            t.H)({
                block: o.W.METRIKA,
                level: null == (a = null == (r = window.Ya) ? void 0 : r.Rum) ? void 0 : a.ERROR_LEVEL.WARN
            }, n) : console.error(n)
        }

        function he(e) {
            return e === p.U_6.PLAYHOP ? le.playhop : le.yandex
        }
        const _e = K((function() {
        ...
        function ge(e, t, ...r) {
            ...
            if (de && a) {
                ...
                if (window.ym || window[`yaCounter${a}`])
                    pe(a, e, t, ...r);
                else {
        ...
        p.Go0.PLAYHOP,
        p.Go0.YANDEX;
        var fe = (e => (e.ADV_IS_NOT_CONNECTED = "ADV_IS_NOT_CONNECTED",
        e.UNKNOWN = "UNKNOWN",
        e))(fe || {});
        const ve = "1" === (0,
        H.VB)(p.x2l)
        ...
        class Pe {
            constructor(e) {
                ...
                this.onAdvManagerExternalMessage = e => {
                    ...
                    case "adv-callback-error":
                        ...
                        try {
                            if ("string" != typeof (null == (a = null == f ? void 0 : f.error) ? void 0 : a.message)) {
                                const e = new Error("Undefined error message");
                                try {
                                    e.additional = JSON.stringify(f)
                                } catch (t) {
                        ...
                        null == (o = (n = this.callbacks).onError) || o.call(n, new Error(f.error.message,{
                            cause: f.error
                        }));
                        break;
                    case "adv-callback-offline":
                        this.callOnAdvClose(!1),
                        null == (s = (i = this.callbacks).onOffline) || s.call(i);
                        break;
                    ...
                    case "rewarded-video-callback-error":
                        null == (g = (_ = this.callbacks).onError) || g.call(_, new Error(f.error.message,{
                            cause: f.error
                        }));
                        break;
                    case "set-disabled-state":
                        be('On "set-disabled-state" event', e.data, f.value),
                        this.setDisabledState(f.value)
                    }
                }
                ,
                this.adv = e.adv || {},
                this.checkDeprecatedOnAdvCloseUsage(),
                (null == (t = window.YandexGamesSDKEnvironment) ? void 0 : t.isWorldWide) ? this.setDisabledState(!0) : ve && Z(),
                ...
                d.Z.onExternalMessage("adv-manager", this.onAdvManagerExternalMessage),
                d.Z.onExternalMessage("adv-debug-manager", this.onAdvDebugManagerExternalMessage),
                this.updateDisabledState()
            }
            checkDeprecatedOnAdvCloseUsage() {
                "onAdvClose"in this.adv && (0,
                l.Ts)(new Error('Deprecated usage "onAdvClose". Please, use `ysdk.adv.method({callbacks})` https://yandex.ru/dev/games/doc/sdk/sdk-adv'))
            }
            ...
            switchStickyBannersDebug(e) {
                this.getBannerAdvStatus().then(( ({stickyAdvIsShowing: t}) => {
                    ...
                    )) : this.showBannerAdv().then(( ({reason: t, stickyAdvIsShowing: r}) => {
            ...
            setDisabledState(e) {
                be("setDisabledState", e),
                e ? W() : Y && (Y = !1)
            }
            showFullscreenAdv({callbacks: e={}}={}) {
                ye("tryOpen", "fullscreen", {
                ...
                d.Z.postToParent({
                    ...
                    if (t) {
                        if ((0,
                        u.mv)() && t.message.includes("often than once per"))
                            throw t;
                        (0,
                        l.fF)(t),
                        Ee(e, "onClose")(!1),
            ...
            callOnAdvClose(e=!1) {
                ...
                null == (r = (t = this.callbacks).onClose) || r.call(t, e)
            }
        ...
        Re && Re.OAUTH_CLIENT_ID,
        Re && Re.SDK_PASSPORT_PREFIX;
        let Ze;
        Ze = r(510).Z;
        const Ke = Ze;
        Object.defineProperty,
        ...
        Object.prototype.propertyIsEnumerable;
        p.xYt.L,
        p.xYt.CATEGORIZED_NEW_L,
        p.xYt.RECOMMENDED_NEW,
        p.xYt.ADAPTIVE_RECOMMENDED_NEW,
        p.xYt.PROFILE_RECENT_GAMES,
        p.xYt.PREMIUM_BIG,
        p.xYt.TV,
        p.xYt.PLAY_SIMILAR_GAMES;
        var He = (e => (e.BIG = "big",
        ...
        function Je(e) {
            ...
            if (null == (t = null == window ? void 0 : window.appData) ? void 0 : t.env) {
                let e = qe(window.location.href, !0, window.appData.env);
                if (e)
                    return r.hostname = e,
                    r.href
            }
        ...
        const Xe = {
            small: He.ISLANDS_RETINA_SMALL,
            medium: He.ISLANDS_RETINA_MEDIUM,
            large: He.ISLANDS_200
        }
          , Qe = {
            small: He.ISLANDS_200,
            medium: He.ISLANDS_200,
            large: He.BIG
        }
          , et = `${We}/player`;
        class tt {
            ...
            getID() {
                return (0,
                l.Ts)(new Error("Player.getID() is deprecated. Please, use Player.getUniqueID().\nhttps://yandex.ru/dev/games/doc/dg/sdk/sdk-player.html#sdk-player__profile-data")),
                Ke.sendOnceDeprecatedUsage("Player.getID"),
            ...
            getMode() {
                var e;
                return V() ? "" : null != (e = this._personalInfo.mode) ? e : ""
            }
            getPhoto(e="medium") {
                const t = Xe[e];
                if (!t)
                    throw new Error(`Unknown size value ('${e}')`);
                return this._personalInfo.avatarIdHash ? `${Je(et)}/avatar/${this._personalInfo.avatarIdHash}/${t}` : `https://avatars.mds.yandex.net/get-yapic/${Ve}/${t}`
            }
            hasPremium() {
                var e;
        ...
        var rt = Object.defineProperty
          ...
          , st = (e, t) => {
            for (var r in t || (t = {}))
                nt.call(t, r) && it(e, r, t[r]);
            if (at)
                for (var r of at(t))
                    ot.call(t, r) && it(e, r, t[r]);
            return e
        }
        ;
        const lt = (e, t) => d.Z.postToParent({
            type: "telegram",
            data: {
                playdeck: st({
                    method: e
        ...
        new Promise(( (e, t) => {
            ...
            d.Z.onExternalMessage("telegram", r),
            setTimeout(( () => {
                d.Z.offExternalMessage("telegram", r),
                t()
            }
        ...
        class Rt {
            ...
            transformLeaderboardEntry(e) {
                const {avatarIdHash: t, lang: r, publicName: a, scopePermissions: n, uniqueID: o} = e.player
                  , i = `${et}/avatar/${t}`;
                return s = ( (e, t) => {
                    for (var r in t || (t = {}))
                        Ot.call(t, r) && It(e, r, t[r]);
                    if (At)
                        for (var r of At(t))
                            Tt.call(t, r) && It(e, r, t[r]);
                    return e
                }
                )({}, e),
                kt(s, St({
                    player: {
                        getAvatarSrc: (e="medium") => (Xe[e] || (e = "medium"),
                        `${i}/${Xe[e]}`),
                        getAvatarSrcSet: (e="medium") => (Xe[e] || (e = "medium"),
                        `${i}/${Xe[e]} 1x, ${i}/${Qe[e]} 2x`),
                        lang: r,
                        publicName: a,
                        scopePermissions: n,
            ...
            getLeaderboardEntries(e, t) {
                const {includeUser: r=!1, quantityAround: a=5, quantityTop: n=5} = t || {}
                  , o = C("Leaderboards.getLeaderboardEntries")
                  , i = Et((0,
                u.H8)("/entries"), {
                    "app-id": this._appId,
                    include_user: r,
                    ...
                    const {entries: t, leaderboard: r, ranges: a, userRank: n} = e;
                    return {
            ...
            setLeaderboardScore(e, t, r) {
                ...
                return "viber" === (0,
                H.VB)("utm_source") && (a.fromViber = !0),
                this.lastTimeLeaderboardWasSend && !this.canSetLeaderboardScoreByTime() ? Promise.reject("The request to setLeaderboardScore can be sent no more than once per second") : (r && (a.extraData = r),
                this.lastTimeLeaderboardWasSend = Date.now(),
                Dt("/score", a))
            }
            canSetLeaderboardScoreByTime() {
                return Date.now() - this.lastTimeLeaderboardWasSend > xt
            }
        }
        const Lt = () => {
            const e = new Rt;
        ...
        function Ft(e, t=Bt, r="") {
            if (e) {
                if ("string" == typeof e)
                    return e;
                if (t in e)
                    return e[t] || r;
                if (!(e => !e || _.includes(e))(t) && "en"in e)
                    return e.en || r;
                if (Bt in e)
                    return e[Bt] || r
            }
        ...
        class Ut {
            ...
            get title() {
                return Ft(this._productData.title)
            }
            get description() {
                return Ft(this._productData.description)
            }
            get imageURI() {
        ...
        function Wt(e) {
            return function(e) {
                for (var t, r = "", a = e.length, n = 0; n < a; n++)
                    t = e[n],
                    r += String.fromCharCode(t > 251 && t < 254 && n + 5 < a ? 1073741824 * (t - 252) + (e[++n] - 128 << 24) + (e[++n] - 128 << 18) + (e[++n] - 128 << 12) + (e[++n] - 128 << 6) + e[++n] - 128 : t > 247 && t < 252 && n + 4 < a ? (t - 248 << 24) + (e[++n] - 128 << 18) + (e[++n] - 128 << 12) + (e[++n] - 128 << 6) + e[++n] - 128 : t > 239 && t < 248 && n + 3 < a ? (t - 240 << 18) + (e[++n] - 128 << 12) + (e[++n] - 128 << 6) + e[++n] - 128 : t > 223 && t < 240 && n + 2 < a ? (t - 224 << 12) + (e[++n] - 128 << 6) + e[++n] - 128 : t > 191 && t < 224 && n + 1 < a ? (t - 192 << 6) + e[++n] - 128 : t);
                return r
            }(function(e, t) {
                for (var r, a, n, o = e.replace(/[^A-Za-z0-9\+\/]/g, ""), i = o.length, s = t ? Math.ceil((3 * i + 1 >>> 2) / t) * t : 3 * i + 1 >>> 2, l = new Uint8Array(s), d = 0, c = 0, u = 0; u < i; u++)
                    if (a = 3 & u,
                    d |= ((n = o.charCodeAt(u)) > 64 && n < 91 ? n - 65 : n > 96 && n < 123 ? n - 71 : n > 47 && n < 58 ? n + 4 : 43 === n ? 62 : 47 === n ? 63 : 0) << 18 - 6 * a,
                    3 === a || i - u == 1) {
                        for (r = 0; r < 3 && c < s; r++,
                        c++)
                            l[c] = d >>> (16 >>> r & 24) & 255;
        ...
        class Ht {
            ...
            getCatalog() {
                return new Promise(( (e, t) => {
                    ...
                    d.Z.postToParent({
                        ...
                        Kt("get-catalog result", t),
                        e(t.products.map((e => new Ut(e))))
                    }
                    )).catch((e => {
                        t(e)
                    }
            ...
            ___test1212() {
                ...
                if ("96458" !== (null == (e = window.YandexGamesSDKEnvironment) ? void 0 : e.app.id))
                    return;
                if (!0 !== (null == (r = null == (t = window.YandexGamesSDKEnvironment) ? void 0 : t.request.experiments) ? void 0 : r.test1212Payments))
                    return;
                const a = "position: fixed; left: 15px; padding: 0.3em; background: #fff; border: 1px solid #000; border-radius: 5px;";
                let n = document.createElement("div");
                n.setAttribute("id", "payElement1212-noads"),
                n.setAttribute("style", `${a} top: 5px;`),
                n.textContent = 'purchase("noads")',
                n.onclick = () => this.___test1212Purchase("noads"),
                document.body.appendChild(n),
                n = document.createElement("div"),
                n.setAttribute("id", "payElement1212-3x3antiblock"),
                n.setAttribute("style", `${a} top: 40px;`),
                n.textContent = 'purchase("3x3antiblock")',
                n.onclick = () => this.___test1212Purchase("3x3antiblock"),
                document.body.appendChild(n)
            }
        ...
        const Vt = function(e={}) {
          ...
          , zt = {
            ...
            isYandexApp: !1,
            isTelegram: !1,
            moneyCodeSymbol: p.NAu.HOP,
            params: {},
            request: {},
            serviceName: p.Go0.YANDEX
        };
        let qt = () => (window.YandexGamesSDKEnvironment || (0,
        l.fF)(new Error("SDK environment: `window.YandexGamesSDKEnvironment` is undefined")),
        qt = () => window.YandexGamesSDKEnvironment || zt,
        qt());
        const Jt = {
            get app() {
                return qt().app
            ...
            get payload() {
                return qt().params.payload
            },
            get isTelegram() {
                return qt().isTelegram
            }
        }
          , Xt = `${We}/player`
          , Qt = 5 * g
                    ...
                    try {
                        ...
                        return function(e) {
                            ...
                            for (let r = e.length - 1; r >= 0; r--) {
                                ...
                                a > 127 && a <= 2047 ? t++ : a > 2047 && a <= 65535 && (t += 2),
                                a >= 56320 && a <= 57343 && r--
                            }
                            return t
                        }(e)
        ...
        function ir(e) {
            const {data: t, signature: r} = function(e) {
                if ("signature"in e) {
                    const {signature: t} = e;
                    if ("string" == typeof t) {
                        const {data: e} = JSON.parse(Wt(t.split(".")[1]));
                        return {
                            data: e,
                            signature: t
                        }
                    ...
                    (0,
                    l.fF)(new Error("response.signature is not a string"))
                }
                return {
                    data: e
                }
        ...
        class mr extends tt {
            constructor(e, t) {
                ...
                this.getDataPromise = () => void 0 !== this.data ? Promise.resolve(this.data) : Jt.isTelegram ? ut().catch(( () => this._fetchData("/data"))) : this.getApiPromise(),
                this.config = t,
                cr && cr.isSamePlayer(this.getUniqueID()) || (cr = new nr(this.getUniqueID()))
            }
            onLogout(e) {
                or("Set onLogout callback"),
                ur = e
            }
            getIDsPerGame() {
            ...
            getData(e) {
                return V() ? Promise.resolve({}) : (this.dataPromise = this.getDataPromise(),
                this.dataPromise.then((t => sr(t, e))))
            }
            setData(e, t=!1) {
                if (V())
                    return new Promise((e => e(!0)));
                var r;
                if (Jt.isTelegram && (r = e,
                lt("setData", {
                    key: dt,
                ...
                const a = function(e, t=!1) {
                    ...
                    return r.error ? r.reject ? Promise.reject(r.error) : ((0,
                    l.Ts)(r.error),
                    Promise.resolve(!0)) : new Promise(( (r, a) => {
                        dr && window.clearTimeout(dr);
                        let n = t ? 200 : Math.max(200, cr.getWaitTime());
                        cr.timestamp = Date.now(),
                        dr = window.setTimeout(( () => {
                            tr("/data", e).then(( () => {
                                cr.dataHash = e,
                                r(!0)
                            }
            ...
            getStats(e) {
                return V() ? new Promise((e => e({}))) : (void 0 === this.statsPromise && (this.statsPromise = new Promise(( (e, t) => {
                    this._fetchData("/stats").then(e).catch(t).finally(( () => this.statsPromise = void 0))
                }
                ))),
                this.statsPromise.then((t => sr(t, e))))
            }
            setStats(e) {
                return V() ? new Promise((e => e(!0))) : lr(e) ? tr("/stats", e) : Promise.reject(new Error("Stats is not valid"))
            }
            incrementStats(e) {
                return V() ? new Promise((e => e(!0))) : lr(e) ? this._postData("/stats/increment", e) : Promise.reject(new Error("Increments is not valid"))
            }
            _fetchData(e) {
                return ( (e, t={}) => _t({
                    api: Je(Xt),
                ...
                u.H8)(`${e}${this.config.signed ? "-signed" : ""}`)).then(ir)
            }
            _postData(e, t) {
                return tr(`${e}${this.config.signed ? "-signed" : ""}`, t).then(ir)
            }
        }
        try {
            pr = window.localStorage
        } catch (e) {}
        const hr = pr || function() {
            let e = {};
            return {
                clear() {
                    e = {}
          ...
          , wr = K(( () => {
            (0,
            l.fF)(new Error("localStorage is broken on iOS/MacOS - https://developer.apple.com/forums/thread/109909\nPlease use YaGames.init().then(ysdk => ysdk.getStorage()).then(storage => storage.setItem('key', 'value'))"))
        }
        ))
          , br = class e {
            static setup() {
                vr && Object.defineProperty(window, "localStorage", {
                    get: function() {
                        return wr(),
                        hr
                    }
                }),
                yr && fr && e.setProxy() && e.backup()
            }
            static load() {
                if (e.onloadPromise_)
            ...
            static getCustomLocalStorage() {
                ...
                return new Proxy({
                    ...
                    getItem: e => hr.getItem.call(hr, e),
                    key: e => hr.key.call(hr, e),
                    get length() {
                        return hr.length
                    },
                    removeItem(e) {
                        hr.removeItem.call(hr, e),
                        d.Z.postToParent({
                            type: "local-storage",
                            action: "del",
                            data: {
        ...
        function Pr() {
            return !yr && pr ? Promise.resolve(pr) : Er.load()
        }
        ...
        var Sr = Object.defineProperty
          ...
          , xr = (e, t) => {
            for (var r in t || (t = {}))
                Or.call(t, r) && Ir(e, r, t[r]);
            if (Ar)
                for (var r of Ar(t))
                    Tr.call(t, r) && Ir(e, r, t[r]);
            return e
        }
        ;
        ...
        function Lr(e) {
            ...
            if ("DIV" === e.tagName && e.getAttribute("style") && !e.querySelector("div") && !e.classList.length && !e.id) {
                ...
                e && (Dr(`popup message = ${e}`),
                d.Z.postToParent({
                    type: "game-call-alert",
                    data: {
                        message: e.substring(0, Rr),
                        popup: !0
                    }
                }))
            }
        ...
        function Cr() {
            ...
            if (Dr("captureUnityAlert isUnity", e),
            !e)
                return;
            if (document.querySelectorAll("div[style]:not([id]):not([class])").forEach(Lr),
            "undefined" != typeof MutationObserver) {
                const e = new MutationObserver((e => {
                    e.forEach((e => {
                        "childList" === e.type && setTimeout(( () => {
                            Array.from(e.addedNodes).forEach(Lr)
                        }
                        ), 0)
                    }
                    ))
        ...
        var Gr = Object.defineProperty
          ...
          , Ur = (e, t) => {
            for (var r in t || (t = {}))
                Fr.call(t, r) && $r(e, r, t[r]);
            if (Br)
                for (var r of Br(t))
                    jr.call(t, r) && $r(e, r, t[r]);
            return e
        }
        ;
        const Yr = ( () => {
        ...
        const Hr = new class {
            ...
            _unsafeHandlePromiseRejectionEvent(e) {
                ...
                let a;
                const n = {};
                r.stack && r.message ? a = r.message : (a = String(r),
                "[object Event]" === a ? a = "event.type: " + r.type : "[object Object]" === a && (n.unhandledObject = r)),
                (null == (t = r.target) ? void 0 : t.src) && (n.src = r.target.src),
                this._postError({
                    additional: n,
            ...
            _unsafeHandleErrorEvent(e, t) {
                ...
                (Yr || (null == s ? void 0 : s.additional)) && (l.additional = Ur(Ur({}, null == s ? void 0 : s.additional), Yr)),
                this._postError(l, t)
            }
            _postError(e, t) {
                var r;
                let a = (0,
                l.Zi)(e.stack);
                "ErrorListener.handleEvent" === a && (a = "unknown"),
                null == (r = this.logger) || r.call(this, {
                    data: {
        ...
        function() {
            try {
                ...
                console.error = (...t) => {
                    ...
                    Wr.Z)(t));
                    try {
                        "string" == typeof t[1] && t[1] === l.X4 ? t.pop() : Zr(Kr(r), "console.error")
                    } catch (e) {}
                    e.apply(console, t)
                }
            } catch (e) {
        ...
        const qr = ["LoadingAPI", "PluginEngineDataReporterAPI"]
          , Jr = class e {
            ...
            ready() {
                ...
                this.logGameInitTime(e, zr.GameReady),
            ...
            startReadyFallbackTimeout() {
                this.readyFallbackTimerId = window.setTimeout(( () => {
                    this.isReady = !0,
                    this.logGameInitTime(e.MAX_TIMEOUT, zr.GameReadyForce)
                }
                ), e.MAX_TIMEOUT)
            }
        }
        ...
        const Qr = {
            ...
            [Vr.PluginEngineDataReporterAPI]: class {
                ...
                report(e) {
                    this.isReported ? console.warn("Don't call %cfeatures.PluginEngineDataReporterAPI.report() %cmore than one time.", "color: green", "color: unset") : (this.logData(e),
                    this.isReported = !0)
                }
                logData(e) {
                    d.Z.postToParent({
        ...
        class ea {
            constructor(e={}) {
                for (let t in Vr)
                    Vr[t]in e && e[Vr[t]] && (this[t] = new Qr[t]);
                for (let t of qr)
                    !this[t] && (t in e && e[t] || !(t in e)) && (this[t] = new Qr[t]);
                d.Z.postToParent({
                    type: "game-measuring",
                    action: zr.GameInit
                })
        ...
        Vr.LoadingAPI,
        Vr.PluginEngineDataReporterAPI;
        const ta = new class {
            canReview() {
                return new Promise((e => {
        ...
        function ia() {
            const e = []
              , t = {
                ...
                webgl: aa(document.createElement("canvas")),
                webgl2: na(document.createElement("canvas"))
            };
            ...
            r = function*() {
                return new Promise(( (e, t) => {
                    ...
                    window.addEventListener("message", (function t(n) {
                        ...
                        o && o.messageId === r && (window.removeEventListener("message", t),
                        clearTimeout(a),
                        e(o.payload))
                    }
                    )),
        ...
        function ua(e, t={}) {
            ...
            function(e={}) {
                return function(e) {
                    Ce || (e.advBlocks.fullscreen = yt.FULLSCREEN,
                    e.advBlocks.fullscreen_landscape = yt.FULLSCREEN)
                }(e),
                function(e) {
        ...
        class ya {
            ...
            isNeedToAskUser() {
                return [ha.AVATAR, ha.NAME].some((e => this._requestedScopes.includes(e) && this._scopePermissions[e] === ga.NOT_SET))
            }
            _validateRequestedScopes(e) {
                let t = [];
                t = Array.isArray(e) ? Array.from(e) : void 0 === e || !0 === e ? [_a] : [];
                const r = t.indexOf(_a);
                return -1 !== r && t.splice(r, 1, ha.AVATAR, ha.NAME),
                t
            }
        }
        const fa = class {
        ...
        function Sa(e={}, t=!0) {
            ...
            return d.Z.postToParent({
            ...
            }).then((r => va(this, [r], (function*({data: r}) {
                o();
                const {data: a, signature: i} = r
                  , s = yield Pa.promise;
                s && [ga.ALLOW, ga.FORBID].includes(s) && ("avatar"in a.scopePermissions && (a.scopePermissions.avatar = s),
                "public_name"in a.scopePermissions && (a.scopePermissions.public_name = s));
                ...
                if ("lite" === l.getMode() || V())
                    ...
                    if (t && r.isNeedToAskUser()) {
                        ...
                        r.show().then(( () => Sa(e, !1))).catch(( () => l)).then((e => n.resolve(e))).finally(( () => {
                            t()
                        }
                        ))
                    } else
        ...
        d.Z.onExternalMessage("auth", (e => {
            ["auth-dialog-cancel", "auth-dialog-success", "changed"].includes(e.data.action) && (wa("Clear getPlayer promises."),
            Ea.clear())
        }
        ));
        class Ta {
            ...
            iframeFocus() {
                Oa(document.querySelector("iframe"))
            }
            updateStatus() {
                d.Z.postToParent({
                    type: "screen-manager",
        ...
        class Ia {
            constructor() {
                this.fullscreen = new Ta
            }
        }
        var xa = (e => (e.EXIT = "EXIT",
        ...
        function Ra() {
            ...
            function t(t) {
                const r = e[t];
                return r || console.warn(`Yandex SDK Event ${t} is not in supported`),
                r || []
            }
        ...
        function Ca(e) {
            ...
            Cache.prototype[e] = function(e, r) {
                return "GET" !== e.method || 0 !== e.url.indexOf("https://") || (a = e.url,
                La.some((e => -1 !== a.indexOf(e)))) ? Promise.resolve() : ("ignoreSearch"in (r = r || {}) || (r.ignoreSearch = !0),
                t.call(this, e, r));
                var a
            }
        }
        ...
        function ja(e={}) {
            const {clientFeatures: t=[], defaultFlags: r={}} = e
              , a = Fa.getFor(e);
            if (a)
                return a.promise;
        ...
        function Ua() {
            return new Promise((e => {
                if ("loading" === document.readyState) {
                    const t = r => {
                        const {target: a} = r;
                        a && "loading" !== a.readyState && (a.removeEventListener("readystatechange", t),
                        e())
                    }
                    ;
        ...
        const qa = (e=null) => {
            var t;
            null === e && (e = window),
            ["testing", "prestable", "production"].includes("production") && !k && (/iPad|iPhone|iPod/.test(window.navigator.platform) || window.navigator.userAgent.includes("Mac") && "ontouchend"in document) && (e.console = (t = ( (e, t) => {
                for (var r in t || (t = {}))
                    Ha.call(t, r) && za(e, r, t[r]);
                if (Ka)
                    for (var r of Ka(t))
                        Va.call(t, r) && za(e, r, t[r]);
                return e
            }
            )({}, console),
            Wa(t, Za({
        ...
        !function() {
            ...
            if ((0,
            u.mv)())
                Dr("alert hook disabled");
            else
                try {
                    "function" == typeof window.alert && (e = window.alert,
                    window.alert = function() {
                        const t = arguments[0];
                        return Dr(`alert message = ${t}`),
                        d.Z.postToParent({
                            type: "game-call-alert",
                            data: {
                                message: t.substring(0, Rr)
                            }
                        }),
        ...
        en = Xa(void 0, null, (function*() {
            return function(r) {
                ...
                )).then(( () => Promise.all(a.map(( ([e]) => new Promise(( (t, a) => {
                    n({
                        id: e,
                        src: s(r, e),
                        parentElement: document.head,
            ...
            ( () => {
                ...
                if (!/(games\.s3\.yandex\.net|games-storage(-awst?)?\.yandex\.net)$/.test(e))
                    return;
                const t = (0,
                u.rh)();
                if (!t)
                ...
                let n;
                n = /games\.s3\.yandex\.net$/.test(e) ? `https://${m(e) ? "ya" : "yandex"}.ru/games/app/${t}${r}${a}` : `https://yandex.com/games/app/${t}${r}${a}`,
        ...
        class an {
            constructor(e) {
                    ...
                    return new Promise(( (a, n) => {
                        ...
                        if (void 0 !== t)
                            try {
                                ...
                                void n(new Error('Wrong "detail" argument'))
                            }
                ...
                ,
                this.onEvent = Ra(),
                this.achievements = F.init(),
                this.adv = new Pe(e),
                this.auth = ke,
                this.clipboard = Nr,
                this.deviceInfo = new Mr(e.deviceType),
                on.deviceInfo = this.deviceInfo,
                this.environment = Jt,
                this.feedback = ta,
                this.isAvailableMethod = (r = this,
                e => {
                    if (V() && ["leaderboards.setLeaderboardScore"].includes(e))
                    ...
                    const t = C("isAvailableMethod")
                      , a = d.Z.postToParent({
                        ...
                        const n = {
                            ...
                            payments: Ht,
                            player: mr,
                            storage: Er.getCustomLocalStorage()
                        };
                        if (n[e])
                            return !1;
                        const o = e.split(".");
                ...
                this.shortcut = Ma,
                this.getLeaderboards = Lt,
                this.getPayments = ma,
                this.getPlayer = Aa,
                this.getStorage = Pr,
                this.notifications = la,
                this.screen = new Ia,
                this.features = new ea(e.features),
                this.yandexApp = {
        ...
        try {
            rn = new URLSearchParams(window.location.hash.slice(1)).get("device-type")
        } catch (e) {}
        class on {
            constructor() {
            ...
            static init(e) {
                return Xa(this, null, (function*() {
                    ...
                    try {
                        const e = yield Xa(void 0, null, (function*() {
                    ...
                    return tn ? (console.warn("YaGames was initialized"),
                    tn) : (this.longtaskObserver(),
                    Qa("Start initialization"),
                    yield en,
                    tn = new Promise(( (r, a) => {
                        !function() {
                            const e = () => {
                        ...
                        const n = n => {
                            try {
                                ...
                                Ua().then(( () => {
                                    const t = new an(e);
                                    t.environment.isTelegram && lt("loading", {
                                        value: 100
                                    }),
                        ...
                        setTimeout(( () => {
                            ...
                            Qa("checkAndSendGameInfo tech data:", e),
                            nn(( () => {
                                d.Z.postToParent({
                                    type: "game-stats",
                                    data: e
                    ...
                    tn.then(( () => Qa("Initialized"))),
                    tn)
                }
                ))
            }
        }
        if (on.deviceInfo = new Mr(rn),
        window.YaGames && window.YaGamesAdded) {
            ...
            (0,
            u.mv)() && window.parent.postMessage({
                source: "YandexGamesSDK",
                type: "alert",
                message: e
            }, "*"),
            ...
            window.parent !== window && window.parent.postMessage({
                ...
                data: {
                    time: Date.now(),
                    sdkVersion: "v2",
                    sdkBundle: null == (Ja = window.YandexGamesSDKEnvironment) ? void 0 : Ja.APP_VERSION,
            ...
            window.top !== window && Ua().then(c),
            Oa(document.querySelector("iframe")),
            Na.overrideCacheSearch(),
            Ba(),
            "SecurityPolicyViolationEvent"in window ? window.addEventListener("securitypolicyviolation", ( ({blockedURI: e, columnNumber: t, disposition: r, documentURI: a, effectiveDirective: n, lineNumber: o, originalPolicy: i, referrer: s, sample: l, sourceFile: c, statusCode: u, violatedDirective: p}) => {
                d.Z.postToParent({
                    type: "csp",
                    action: "violation",
                    data: {
